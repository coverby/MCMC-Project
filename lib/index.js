...
function main() {
    ...
    if (rl.keyInYN('Do you want a report in the terminal?')) {
        ...
        console.log(`Expected number of edges from node 0 in top 1%: ${result.avg0}`);
        console.log(`Expected number of total edges in top 1%: ${result.avge}`);
        console.log(`Expected maximum optimal path length in top 1%: ${result.avgw}`);
    }
